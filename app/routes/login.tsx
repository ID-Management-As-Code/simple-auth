    ...
    return (
        <div className="flex-grow flex flex-col justify-center py-12 px-6 lg:px-8 sm:bg-gray-50">
            <div className="sm:mx-auto sm:w-full sm:max-w-md">
                <h1 className="font-rokkitt font-semibold text-6xl text-center">
                    <span className="text-slate-600">Simple</span>
                    <span className="text-blue-600">Auth</span>
                </h1>

                <h2 className="mt-6 text-center text-4xl font-rokkitt font-extrabold text-gray-900">Sign in to your account</h2>
